...
from saxsshow import MyMplCanvas3
	...
	def she(self):
		...
		if she_structure=='':
			...
			if she_expt_data =='':
				...
				sc = MyMplCanvas3(q_list,logi_list,fitq_list,fiti_list,saxq_list,saxi_list,"q","Intensity","intensity curve for PDB model","intensity curve fit saxs data","intensity curve for saxs data","Q-Intensity Curve Comparison")
